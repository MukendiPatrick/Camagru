...
function photo_without_frame(id) {
    ...
    fileReader.onload = function(fileLoadedEvent) {
      ...
      if (postData.length > 0) {
        if (srcData.match(/png/)) {
          ...
          xhr.open("POST", "../back_end/create_img.php", true);
                ...
                if ((this.responseText))
                {
                ...
                else
                  {
                    ...
                    var text2 = document.createTextNode(
                      "Incorrect image format. Please choose png format!"
                    );
        ...
        var div = document.createElement("div");
        var p = document.createElement("p");
        var text2 = document.createTextNode("Please choose the filter");
        div.className = "alert alert-danger";
        p.className = "p_danger";
        p.appendChild(text2);
        div.appendChild(p);
...
(function() {
  ...
  startbutton.addEventListener(
    "click",
    function(ev) {
      if (postData.length > 0) take_photo();
      else {
        var div = document.createElement("div");
        var p = document.createElement("p");
